...
$update = mysqli_query($conn, $query = "SELECT * FROM m_category_ticket WHERE category_ticket_id=$id");
                ...
                <form action="" method="post">
                  ...
                  <div class="form-group">
                    ...
                    <select name="status" id="status" class="form-control">
                      <option <?php if ($category['status'] === 'enabled'): ?> selected <?php endif;?> value="enabled">Enabled</option>
                      <option <?php if ($category['status'] === 'disabled'): ?> selected <?php endif;?> value="disabled">Disabled</option>
                    </select>
                  </div>
                  <div class="form-group">
