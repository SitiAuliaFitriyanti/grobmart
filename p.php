...
echo $attachment;
    ?>
                            ...
                            <form method="post" enctype="multipart/form-data">
                                ...
                                <div class="tombol">
                                    <button type="submit" name="reply" class="btn btn-primary btn-md">Reply</button>
                                    <button type="submit" name="solved" class="btn btn-primary btn-md">Solved</button>
                                    <?php
